/**
 * SQLite database access layer for the ÚOOÚ SR MCP server.
 *
 * Schema:
 *   - decisions    — ÚOOÚ SR decisions, sanctions, and rozhodnutia
 *   - guidelines   — ÚOOÚ SR guidance documents and usmernenia
