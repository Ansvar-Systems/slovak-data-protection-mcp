      ...
      switch (name) {
        ...
        case "sk_dp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "ÚOOÚ SR (Úrad na ochranu osobných údajov Slovenskej republiky) MCP server. Provides access to French data protection authority decisions, sanctions, mises en demeure, and official guidance documents.",
